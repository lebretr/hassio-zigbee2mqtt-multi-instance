<div align="center">
    ...
    <h1>Zigbee2MQTT Multi-Instance Home Assistant app based on the Official Zigbee2MQTT Home Assistant app </h1>
</div>
...
1. Go back to the **App store**, click **⋮ → Repositories**, fill in</br> `https://github.com/lebretr/hassio-zigbee2mqtt-multi-instance` and click **Add → Close** or click the **Add repository** button below, click **Add → Close** (You might need to enter the **internal IP address** of your Home Assistant instance first).
...
For configuration, refer to [the documentation of the official app](https://github.com/zigbee2mqtt/hassio-zigbee2mqtt)